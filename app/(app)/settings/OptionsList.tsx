  ...
  return (
    <div className="card settings-anim optcard" style={{ padding: 18 }}>
      ...
      <div className="optrows">
        {items.length === 0 && <span style={{ fontSize: 12.5, color: "var(--muted)", fontStyle: "italic", padding: "6px 2px" }}>{tr("noItemsYet")}</span>}
        {items.map((it) => (
          editId === it.id ? (
            <div key={it.id} className="optrow editing">
              <input className="ei" autoFocus value={editVal}
