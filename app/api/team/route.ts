...
export async function POST(req: Request) {
  ...
  const VIEW_KEYS = ["can_view_dashboard","can_view_customers","can_view_tasks","can_view_batches","can_view_refunds","can_view_archive","can_view_pipeline","can_view_support","can_view_activations","can_view_universities","can_view_receipts","can_view_education","can_view_feedback","can_view_prices","manage_campaign_settings"];
